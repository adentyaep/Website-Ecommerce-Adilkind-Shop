        ...
        <div class="container p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Cupang Halfmoon Biru </li>
                </ol>
              </nav>
            <div class="row mb-4">
                <div class="col-md">
                  <form action="checkout.html">
                    <div class="card shadow p-3 mb-5" >
                        <a href="img/halmon-biru.jpg"><img class="card-img-top" src="img/100/halmon-biru.jpg" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title" id="namaIkan">Cupang Halfmoon Biru</h5>
                            ...
                            <h3 class="card-title" id="hargaIkan">Rp 45000</h3>
