        ...
        <div class="container p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Cupang Halfmoon Merah</li>
                </ol>
              </nav>
            <div class="row mb-4">
                <div class="col-md">
                  <form action="checkout.html">
                    <div class="card shadow p-3 mb-5" >
                        <a href="img/halmon-merah.jpg"><img class="card-img-top" src="img/100/halmon-merah.jpg" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title" id="namaIkan">Cupang Halfmoon Merah</h5>
                            ...
                            <h3 class="card-title" id="hargaIkan">Rp 50000</h3>
                    ...
                    <div class="card shadow p-3 mb-5 ">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Mrs. boysi</h5>
                          <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                          <p class="card-text">Cupangnya keren abis</p>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Mr. Ayaku</h5>
