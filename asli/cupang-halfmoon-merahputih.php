        ...
        <div class="container p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Cupang Halfmoon Merah Putih</li>
                </ol>
              </nav>
            <div class="row mb-4">
                <div class="col-md">
                  <form action="checkout.html">
                    <div class="card shadow p-3 mb-5" >
                        <a href="img/halmon-merah-putih.jpg"><img class="card-img-top" src="img/100/halmon-merah-putih.jpg" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title" id="namaIkan">Cupang Halfmoon Merah Putih</h5>
                            <p class="card-text text-justify">Cupang halfmoon merupakan hasil perkawinan silang yang dilakukan oleh breeder alias pembiak asal Amerika Serikat, Peter Geottner pada 1980-an. Awalnya, Goettner sukses menghasilkan cupang yang memiliki bukaan ekor lebar mendekati 180 derajat dan berwarna hijau.</p>
                            <h3 class="card-title" id="hargaIkan">Rp 42000</h3>
