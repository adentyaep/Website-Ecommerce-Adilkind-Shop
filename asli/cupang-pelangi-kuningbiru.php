                ...
                <div class="col-md">
                  <form action="checkout.html">
                    <div class="card shadow p-3 mb-5" >
                        <a href="img/betta-pelangi2.jpg"><img class="card-img-top" src="img/100/betta-pelangi2.jpg" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title" id="namaIkan">Cupang Betta Pelangi Biru Kuning</h5>
                    ...
                    <div class="card shadow p-3 mb-5 ">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Mrs. Selly</h5>
                          <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                          <p class="card-text">Cupangnya keren abis</p>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Mr. Abing</h5>
