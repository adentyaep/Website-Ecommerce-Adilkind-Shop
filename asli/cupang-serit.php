                ...
                <div class="col-md">
                  <form>
                    <div class="card shadow p-3 mb-5" >
                        <a href="img/cupang2.jpg"><img class="card-img-top" src="img/100/cupang2.jpg" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title" id="namaIkan" name="cupang">Cupang Serit</h5>
                            <p class="card-text text-justify">Cupang Serit adalah cupang asli Indonesia dengan ciri khas tersendiri yaitu memiliki sirip dan ekor menyerupai sisir dan karena hal ini lah disebut cupang serit atau crown tail. </p>
