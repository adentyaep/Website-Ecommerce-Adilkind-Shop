        ...
        <div class="container p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Guppy Kuning Hitam</li>
                </ol>
              </nav>
            <div class="row mb-4">
                <div class="col-md">
                  <form >
                    <div class="card shadow p-3 mb-5" >
                        <a href="img/guppy2.jpg"><img class="card-img-top" src="img/100/guppy2.jpg" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title" id="namaIkan">Guppy Kuning Hitam</h5>
                            ...
                            <h3 class="card-title" id="hargaIkan">Rp 25000</h3>
