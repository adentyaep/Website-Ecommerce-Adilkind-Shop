        ...
        <div class="container p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Guppy Oranye List Sirip Biru</li>
                </ol>
              </nav>
            <div class="row mb-4">
                <div class="col-md">
                  <form >
                    ...
                    <div class="card shadow p-3 mb-5 ">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Mr. arming</h5>
                          <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                          <p class="card-text">Guppy nya keren abis</p>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Mrs. Ayasi</h5>
                            <i class="fas fa-star"></i><i class="fas fa-star"></i></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                            <p class="card-text">Guppy keren</p>
                          </div>
                      </div>
