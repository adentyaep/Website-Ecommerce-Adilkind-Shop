        ...
        <div class="container p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Guppy Merah Hijau</li>
                </ol>
              </nav>
            <div class="row mb-4">
                <div class="col-md">
                  <form>
                    <div class="card shadow p-3 mb-5" >
                        <a href="img/guppy-merah.jpg"><img class="card-img-top" src="img/100/guppy-merah.jpg" alt="Card image cap"></a>
                        <div class="card-body">
                            <h5 class="card-title" id="namaIkan">Guppy Merah Hijau</h5>
